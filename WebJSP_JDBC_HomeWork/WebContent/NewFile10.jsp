	...
	2.화면 1개(기존에 입력내용 보여주는 것)-> 처리 1개 (수정처리)
	 2.1  DB select 한 결과 화면 출력 
	   <input type="text" value="rs.getString(id)">
	      ...
	      수정안하고 .. 화면 .. 전송   : <input type="text" value="rs.getString(id)" name = "" readonly>
	      수정하고 ..화면  ..전송   :  <input type="text" value="rs.getString(id)" name = "">
...
<body>
		...
		<div style="height: 700px">
			<td style="width: 700px">
				<form action="NewFile11.jsp" method="post">
					...
					<div>
						<table
							...
							<tr>
								...
								<a href='NewFile6.jsp'>리스트이동</a></td>
						</table>
