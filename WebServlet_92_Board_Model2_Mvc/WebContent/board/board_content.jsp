		...
		$.ajax(
				{
					...
					data: {id:$('#idx').val() , no:$('#no').val() , pwd:$('#delPwd').val()},
					console.log(data);
					dataType: "text",
				...
				<table width="80%" border="1">
					...
					<tr>
						<td colspan="4" align="center"><a 
							...
							href="board_edit.do?idx=${param.idx}&cp=${param.cp}&ps=${param.ps}">편집</a>
							|<a
					...
					%>
						<tr align="left">
							...
							<!--  <form action="boardreply_deleteOk.do" method="POST" name="replyDel"> -->
								<input type="hidden" id = "no" name="no" value="<%=reply.getNo()%>"> 
